...
usersRouter.post('/', async (request, response) => {
  ...
  // nivel de encriptado para la contraseña
  const saltRounds = 10;
  ...
  // desde aca es para enviar un email
  ...
  async function main() {
    // en el email mandamos un link con la pagina principal + el id del usuario
